...
import com.sbs.rko.at.service.MemberService;
...
public class MemberController {
	...
	public String doWrite(@RequestParam Map<String, Object> param, Model model) {
		...
		ResultData checkLoginIdJoinableResultData = memberService.checkLoginIdJoinable((String)Util.getAsStr(param.get("loginId")));
